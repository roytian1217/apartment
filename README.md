...
1.产品发现与产品析取分为不同的spider（urlspider、contentspider） √
2.【更稳定】增量url池，不以每天房源列表的url为准，因为房源列表有反爬，可能今天爬得到的url，明天就没了，增量url池可以解决这个问题，每天新增、修改url池，让数据更稳定分析更准确 [TODO]
3.【更快速】contentspider改为scrapy-redis分布式监听redis，每天url存入redis，分布式的析取房源信息 [TODO]
<br>
